    ...
    <div class="content-body">
        <div class="row align-items-center mb-4">
            ...
            <div class="col-md-6 text-end">
                <a href="{{ route('adminsekolah.data-siswa.export') }}" class="btn btn-success">
                ...
                <form id="filterForm" class="row g-3">
                    <div class="col-md-4">
                        <div class="input-group bg-light rounded-pill border-0 px-3">
                            ...
                            <input type="text" id="searchInput" name="search"
                                class="form-control bg-transparent border-0 py-2 text-sm"
                    ...
                    <div class="col-md-2">
                        <button type="button" id="resetFilter"
                            class="btn btn-outline-secondary w-100 rounded-pill fw-bold text-sm">Reset</button>
                    </div>
                </form>
            </div>
        </div>
