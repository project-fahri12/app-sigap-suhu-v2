                ...
                <div class="card border-0 shadow-sm rounded-4" style="background: linear-gradient(135deg, #1e4d3a, #198754); color: white;">
                    <div class="card-body p-4 d-flex flex-wrap align-items-center justify-content-between">
                        <div>
                            ...
                            <p class="mb-0 opacity-75">Integrasi Data Hunian, Kedisiplinan, dan Sarana Prasarana.</p>
                        </div>
        ...
        <div class="row g-3 mb-4">
            <div class="col-6 col-lg-3">
                <div class="card border-0 shadow-sm rounded-4 p-3 border-start border-success border-5 h-100">
                    <small class="text-muted fw-bold text-uppercase">Total Santri</small>
                    <h3 class="fw-bold text-success mb-0">452 <small class="fs-6 text-muted fw-normal">Orang</small></h3>
                </div>
            </div>
            <div class="col-6 col-lg-3">
                <div class="card border-0 shadow-sm rounded-4 p-3 border-start border-primary border-5 h-100">
                    <small class="text-muted fw-bold text-uppercase">Kapasitas Kamar</small>
            ...
            <div class="col-6 col-lg-3">
                <div class="card border-0 shadow-sm rounded-4 p-3 border-start border-info border-5 h-100">
                    <small class="text-muted fw-bold text-uppercase">Loker Aktif</small>
                    <h3 class="fw-bold text-info mb-0">465 <small class="fs-6 text-muted fw-normal">Slot</small></h3>
                </div>
            </div>
            <div class="col-6 col-lg-3">
                <div class="card border-0 shadow-sm rounded-4 p-3 border-start border-warning border-5 h-100">
                    <small class="text-muted fw-bold text-uppercase">Loker Kosong</small>
                    <h3 class="fw-bold text-warning mb-0">15 <small class="fs-6 text-muted fw-normal">Slot</small></h3>
                </div>
            </div>
        </div>
            ...
            <div class="col-xl-8">
                <div class="card border-0 shadow-sm rounded-4 mb-4">
                    <div class="card-header bg-white border-0 pt-4 px-4">
                        ...
                        <small class="text-muted">Perbandingan data pendaftaran 6 bulan terakhir</small>
                    </div>
                    ...
                    <div class="card-body p-4">
                        ...
                        <div class="list-group list-group-flush bg-transparent">
                            <a href="#" class="list-group-item list-group-item-action bg-transparent border-0 px-0 d-flex align-items-center">
                                ...
                                <div class="small">Brosur Pendaftaran 2026.pdf</div>
                            </a>
                            <a href="#" class="list-group-item list-group-item-action bg-transparent border-0 px-0 d-flex align-items-center">
                ...
                <div class="card border-0 shadow-sm rounded-4">
                    ...
                    <div class="card-body p-4">
                        <div class="mb-4">
                            ...
                            <p class="text-muted mb-2" style="font-size: 11px;">E-Perizinan & Kontrol Keluar Masuk Santri</p>
                        ...
                        <div class="mb-4">
                            <div class="d-flex justify-content-between align-items-center mb-1">
                                <span class="small fw-bold text-dark"><i class="fas fa-box-open text-primary me-2"></i>Sarana Prasarana</span>
                                <span class="badge bg-light text-muted fw-normal" style="font-size: 9px;">TAHAP 2</span>
                            </div>
                            <p class="text-muted mb-2" style="font-size: 11px;">Inventaris Aset & Laporan Kerusakan Fasilitas</p>
                            <div class="progress" style="height: 5px;">
                        ...
                        <div class="mb-0">
                            <div class="d-flex justify-content-between align-items-center mb-1">
                                <span class="small fw-bold text-dark"><i class="fas fa-graduation-cap text-success me-2"></i>Pendidikan</span>
                                <span class="badge bg-light text-muted fw-normal" style="font-size: 9px;">TAHAP 3</span>
                            </div>
                            <p class="text-muted mb-2" style="font-size: 11px;">Raport Digital, Tahfidz, & Absensi Kitab</p>
                            <div class="progress" style="height: 5px;">
