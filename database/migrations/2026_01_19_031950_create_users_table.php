...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('users', function (Blueprint $table) {
            ...
            $table->enum('role', ['super-admin', 'admin-sekolah', 'admin-pondok', 'panitia-ppdb','pendaftar'])->default('pendaftar');
            ...
            $table->enum('is_aktif', ['aktif', 'non_aktif'])->default('non_aktif')->nullable();
            $table->rememberToken();
            $table->timestamps();
        });
