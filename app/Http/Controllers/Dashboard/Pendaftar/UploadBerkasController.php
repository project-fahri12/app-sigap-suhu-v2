...
class UploadBerkasController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        DB::transaction(function () use ($request, $pendaftarId) {
            ...
            $fileName = "{$jenis}_{$pendaftarId}_".now()->timestamp.'.'.$file->getClientOriginalExtension();
            ...
            // Update status pendaftar (SATU QUERY)
            DB::table('pendaftars')
